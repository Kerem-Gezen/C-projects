//Basit ATM yapisi do-while dongusu ve switch-case ile.
#include<stdio.h>
int main(){
	int islem;
	int tekrar=1;                           //dongunun kontrol degiskeni 'tekrar'.
	...
	scanf("%d",&islem);
		...
		if( islem<1 || islem>5){			 				       //belirli araliktaki islemlerden farkli bir sayi girilince donguyu tekrarlar continue ile.
			printf("Gecersiz giris! Lutfen tekrar deneyin.\n\n");
			continue;						                      //contunie can alici yer burada dongunun tekrarlamasini sagliyor.
